...
$python = Initialize-DyDataRuntime -Root $repoRoot
...
$rawScript = Join-Path $repoRoot "scripts\exports\export_raw_orders.py"
$backfillScript = Join-Path $repoRoot "scripts\utilities\backfill_coupon_status.py"
