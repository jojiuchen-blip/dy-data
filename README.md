...
系统输出经营与分账参考，不执行真实资金划拨。产品总览以 [项目产品介绍书](docs/项目产品介绍书.md) 为准；项目级业务目标、角色、范围、成功标准和风险边界以 [权威 BRD](docs/brd/BRD-dy-data-20260716-1255.md) 为准。
...
- [项目产品介绍书](docs/项目产品介绍书.md)：当前产品总览与四个业务域导航。
- [权威 BRD](docs/brd/BRD-dy-data-20260716-1255.md)：项目级业务目标、角色、痛点、范围、成功标准、风险与下游边界。
