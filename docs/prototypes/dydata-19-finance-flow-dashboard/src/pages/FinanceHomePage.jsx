...
const entries = [
  ...
  { page: "finance-imports", icon: "document", title: "导入记录", detail: "追踪四类批量导入的校验、覆盖和永久审计记录。" },
];
  ...
  return (
    <section className="business-page finance-home" aria-labelledby="finance-home-title">
      ...
      <div className="finance-entry-grid">
        {entries.map((entry) => (
          <button type="button" className="finance-entry" key={entry.page} onClick={() => onNavigate(entry.page)}>
