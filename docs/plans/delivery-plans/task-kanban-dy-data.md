...
| T5.1 | [财务闭环 Schema 与领域地基](sub-delivery-plan-dy-data-T5.1-finance-schema.md) | AI 执行 -> 人审核 | PRD/Foundation 冻结 | 待审阅 | - | 第一批最小闭环；8 张表、模型、迁移与结构测试 |
| T5.2 | [门店确认与推广费发票登记](sub-delivery-plan-dy-data-T5.2-store-billing.md) | AI 执行 -> 人审核 | T5.1 | 待审阅 | - | 门店账单、分方向确认、推广费四态发票登记 |
| T5.3 | [管理员财务查询与订单穿透](sub-delivery-plan-dy-data-T5.3-finance-queries.md) | AI 执行 -> 人审核 | T5.1、T5.2 | 待审阅 | - | 单月/累计、双方向、门店与订单查询 |
| T5.4 | [账单异议生命周期](sub-delivery-plan-dy-data-T5.4-disputes.md) | AI 执行 -> 人审核 | T5.1、T5.2 | 待审阅 | - | 门店提交/撤回、管理员处理、新账单版本 |
