...
- 2026-09-10收尾：本地全仓2789 passed/144 skipped/1 failed，唯一失败为浏览器测试StaticPool并发共享SQLite连接；测试夹具修正后整组256 passed。最终CI 2773 passed/161 skipped，发布1ec89c0c成功。2204条有效可见线索号码缓存缺口219→0，页面掩码和完整号码读取通过；重复分配与新增自动超期0，priority_daily与auto_sync_enabled=false保持。测试数据库已停止。DYDATA-90整体历史积压与72小时观察仍未完成，issue不关闭。
